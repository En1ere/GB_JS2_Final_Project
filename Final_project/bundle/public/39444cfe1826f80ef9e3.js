Vue.component('product-page', {
  ...
  mounted() {
    this.$parent.getJson('/api/product').then(data => {
      this.product.id_product = data.id_product, this.product.product_name = data.product_name, this.product.price = data.price, this.product.img = data.img;
      console.log(this);
    });
  },
  ...
  template: `<section class="product__page">
                    ...
                    <section class="product__page-img-slider">
                        ...
                        <img :src="this.product.img" alt="product_img" class='product__page-img'>
                    ...
                    <div class="product__page-description">
                        <div class="product__page-description-charachteristic">
                            ...
                            <h2 class="product__page-description-head2">{{ product.product_name }}</h2>
                            ...
                            <p class="product__page-description-price">&#36;{{ this.product.price }}</p>
                        </div>
